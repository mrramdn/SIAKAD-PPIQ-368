...
Mudir menyiapkan mata pelajaran, peserta, ustadz pengampu, dan jadwal. Ustadz maupun Wali Kelas mengisi nilai dan absensi hanya pada mata pelajaran yang ditugaskan. Di akhir semester, Wali Kelas merekap nilai dan kehadiran menjadi Rapor Semester, menuliskan catatan, lalu mengirimkannya untuk di-ACC dan diterbitkan oleh Administrasi setelah checklist administrasi santri lunas. Wali santri melihat rapor anaknya setelah status berubah menjadi `PUBLISHED`.
...
6. **Kewenangan Minimum**: Administrasi mengelola akun dan administrasi santri, Mudir mengelola data akademik (kelas, mapel, kelompok penilaian), ustadz mengelola mapel yang diampu, dan Wali Kelas mengelola rapor.
