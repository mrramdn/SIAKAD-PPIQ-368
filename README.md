...
6. **Absensi Ustadz dan BKKH**: kehadiran harian pengajar/wali kelas + checklist kegiatan harian wajib (BKKH); ustadz menandai kehadiran dan kegiatannya sendiri, administrasi mengelola daftar kegiatan dan mencatat kehadiran, mudir memantau.
...
- `app/(app)`: app shell (sidebar + topbar) untuk pengguna terverifikasi
  ...
  - `absen-ustadz`: absensi harian pengajar/wali kelas + checklist BKKH + rekap bulanan
